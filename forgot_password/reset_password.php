...
<!-- <header class="Header">
    <h4> Reset password </h4>
        ...
        <div class="btn">
            <input type="submit"name="reset_password_btn"value="SEND LINK" id="b" >
        </div>
        </form>
    </header> -->
...
<div class=" form-outline row mb-3  m-auto " >
         ...
         <p class="text-center fw-bold fs-4 text-secondary mb-0">RESET PASSWORD</p>
     </div>
 ...
 <form action="reset_password_code.php" method="post">
     ...
     <div class="form-outline row md-2 m-auto ">
         <div class="col-sm-12">
         <input type="submit" class="btn btn-secondary mx-1 w-25 text-right" name="reset_password_btn" value="SEND LINK" id="b">
